...
public class Omr {
	...
	private static String QrCodeFailedPath;
	public static String GetFailedPath;
	private static String ProcessQrCodeFailedAttempts;
	
	public static void setProcessQrCodeFailedAttempts(String value)
	{
		ProcessQrCodeFailedAttempts=value;
	}
	public static String GetCurrentFolder()
	{
		return path;
	}
	public static String GetQrCodeFailedPath()
	{
		return QrCodeFailedPath;
	}
	...
	public static void main(String[] args) throws IOException {
		...
		if(args.length==2 && args[1].contains("yes"))
			ProcessQrCodeFailedAttempts=args[1];
		else
			ProcessQrCodeFailedAttempts="no";
		...
		if(mk("./debug") && mk("./log") && mk("./"+session) && mk("./"+session+"/success") && mk("./"+session+"/fail") && mk("./"+session+"/code") ){
			...
			control=new OmrController(fh, view,session,ProcessQrCodeFailedAttempts);
			control.startApp();
		}else{
